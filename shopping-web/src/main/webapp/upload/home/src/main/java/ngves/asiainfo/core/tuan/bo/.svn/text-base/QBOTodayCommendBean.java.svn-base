...
public class QBOTodayCommendBean extends DataContainer implements DataContainerInterface, IQBOTodayCommendValue {
	...
	private static String m_boName = "ngves.asiainfo.core.tuan.bo.QBOTodayCommend";
	...
	public QBOTodayCommendBean() throws AIException {
		super(S_TYPE);
	}
