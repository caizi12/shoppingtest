...
public class AllegeInfoBean extends DataContainer implements DataContainerInterface, IAllegeInfoValue {

    /**
       * 
       */
    private static final long serialVersionUID = -6974652811872874604L;

    private static String m_boName = "ngves.asiainfo.core.common.bo.AllegeInfo";
    ...
    public AllegeInfoBean() throws AIException {
        super(S_TYPE);
    }
