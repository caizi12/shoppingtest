...
public class ActivityIntegralBean extends DataContainer implements DataContainerInterface,IActivityIntegralValue{

  private static String  m_boName = "ngves.asiainfo.core.ware.bo.ActivityIntegral";
  ...
  public ActivityIntegralBean() throws AIException{
