...
public class BusiSmsFormworkOccasionRltBean extends DataContainer implements DataContainerInterface,
		IBusiSmsFormworkOccasionRltValue {

	private static final long serialVersionUID = -4313673628178895371L;

	private static String m_boName = "ngves.asiainfo.core.smsformwork.bo.BusiSmsFormworkOccasionRlt";
	...
	public BusiSmsFormworkOccasionRltBean() throws AIException {
		super(S_TYPE);
	}
