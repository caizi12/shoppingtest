...
public class QBOCommentInfoBean extends DataContainer implements DataContainerInterface,IQBOCommentInfoValue{

	
	private static final long serialVersionUID = 7888941949958507872L;
	private static String  m_boName = "ngves.asiainfo.core.comment.QBOCommentInfo";
...
//增加礼品大类id和name
  ...
  public QBOCommentInfoBean() throws AIException{
      super(S_TYPE);
  }
