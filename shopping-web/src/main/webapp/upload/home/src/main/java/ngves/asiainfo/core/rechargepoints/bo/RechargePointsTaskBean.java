...
public class RechargePointsTaskBean extends DataContainer implements DataContainerInterface, IRechargePointsTaskValue {

	/**
	 * 
	 */
	private static final long serialVersionUID = 9160242212622586331L;

	private static String m_boName = "ngves.asiainfo.core.rechargepoints.bo.RechargePointsTask";
	...
	public RechargePointsTaskBean() throws AIException {
		super(S_TYPE);
	}
