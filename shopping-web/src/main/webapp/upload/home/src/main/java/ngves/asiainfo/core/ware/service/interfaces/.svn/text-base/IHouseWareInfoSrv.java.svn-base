 ...
 *
 */
public interface IHouseWareInfoSrv {
     ...
     */
	 ...
	 public void setHouseWareInfoDAO(IHouseWareInfoDAO houseWareInfoDAO) throws Exception ;
    public IQBOHouseWareInfoValue[] getHouseWareInfo(String ware_code, String ware_name, String ware_status,
            ...
            String warehouse_id, String warehouse_type,String provinceCode,String comType,String staffId,String ware_kind_info, int startIndex, int endIndex) throws Exception;
