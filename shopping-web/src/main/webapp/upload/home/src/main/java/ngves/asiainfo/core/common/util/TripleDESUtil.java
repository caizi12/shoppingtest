...
public class TripleDESUtil {
	...
	public static int[] sBoxPermute(int[] expandByte) {
		...
		String binary = "";
		int[][] s1 = { { 14, 5, 13, 1, 2, 15, 11, 8, 3, 10, 6, 12, 5, 9, 0, 7 },
				{ 0, 15, 7, 4, 14, 2, 13, 1, 10, 6, 12, 11, 9, 5, 3, 8 },
				{ 4, 1, 14, 8, 13, 6, 2, 11, 15, 12, 9, 7, 3, 10, 5, 0 },
				{ 15, 12, 8, 2, 4, 9, 1, 7, 5, 11, 3, 14, 10, 0, 7, 13 } };
		...
		int[][] s6 = { { 12, 1, 10, 15, 9, 2, 6, 8, 0, 13, 3, 4, 14, 7, 5, 11 },
				...
				{ 9, 14, 15, 5, 2, 8, 12, 3, 7, 0, 4, 10, 2, 13, 11, 6 },
		...
		int[][] s7 = { { 4, 11, 2, 14, 15, 0, 8, 13, 3, 12, 9, 7, 5, 10, 6, 1 },
				...
				{ 6, 11, 13, 8, 1, 4, 10, 7, 9, 6, 0, 15, 14, 2, 3, 12 } };
	...
	//TripleDESUtil en = new TripleDESUtil();

		String fKey = "UUY18wMBVMUJbSQY";/* 必需的密钥 */
		String sKey = "VcZ0YxYq1JEwZ1UT";
		String tKey = "5J5vNXqHXqbswQcZ";

		//String data = "888888";
		String data = "TEST001";
		String strs = TripleDESUtil.strEncode(data, fKey, sKey, tKey);
		String decs = TripleDESUtil.strDecode(strs, fKey, sKey, "5J5vNXqHXqbswQcZ");
