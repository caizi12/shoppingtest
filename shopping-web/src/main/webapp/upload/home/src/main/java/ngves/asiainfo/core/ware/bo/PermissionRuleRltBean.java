...
public class PermissionRuleRltBean extends DataContainer implements DataContainerInterface, IPermissionRuleRltValue {
	...
	private static String m_boName = "ngves.asiainfo.core.ware.bo.PermissionRuleRlt";
	...
	public PermissionRuleRltBean() throws AIException {
