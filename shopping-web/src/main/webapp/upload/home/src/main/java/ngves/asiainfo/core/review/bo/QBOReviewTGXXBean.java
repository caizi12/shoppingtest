...
public class QBOReviewTGXXBean extends DataContainer implements DataContainerInterface,IQBOReviewTGXXValue{
...
private static String  m_boName = "ngves.asiainfo.core.review.bo.QBOReviewTGXX";
  ...
  public QBOReviewTGXXBean() throws AIException{
      super(S_TYPE);
  }
