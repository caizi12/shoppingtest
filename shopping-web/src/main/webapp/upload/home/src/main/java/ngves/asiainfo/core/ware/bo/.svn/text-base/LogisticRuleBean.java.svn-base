...
public class LogisticRuleBean extends DataContainer implements DataContainerInterface,ILogisticRuleValue{
...
private static String  m_boName = "ngves.asiainfo.core.ware.bo.LogisticRule";
  ...
  public LogisticRuleBean() throws AIException{
