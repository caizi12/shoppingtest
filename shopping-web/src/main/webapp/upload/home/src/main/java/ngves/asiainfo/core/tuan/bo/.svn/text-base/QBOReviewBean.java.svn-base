...
public class QBOReviewBean extends DataContainer implements DataContainerInterface,IQBOReviewValue{

  /**
	 * 
	 */
	private static final long serialVersionUID = -6522243176042209831L;



private static String  m_boName = "ngves.asiainfo.core.tuan.bo.QBOReview";
  ...
  public QBOReviewBean() throws AIException{
