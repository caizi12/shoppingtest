...
public class AwardLevelInfoBean extends DataContainer implements DataContainerInterface,IAwardLevelInfoValue{
...
private static String  m_boName = "ngves.asiainfo.core.award.bo.AwardLevelInfo";
  ...
  public AwardLevelInfoBean() throws AIException{
      super(S_TYPE);
  }
