...
public class QBODonatedWareBindBean extends DataContainer implements DataContainerInterface, IQBODonatedWareBindValue {
	...
	private static String m_boName = "ngves.asiainfo.core.donated.bo.QBODonatedWareBind";
	...
	public QBODonatedWareBindBean() throws AIException {
