...
public class BusiActivityIntegralBean extends DataContainer implements DataContainerInterface,IBusiActivityIntegralValue{

  private static String  m_boName = "ngves.asiainfo.core.ware.bo.BusiActivityIntegral";
  ...
  public BusiActivityIntegralBean() throws AIException{
