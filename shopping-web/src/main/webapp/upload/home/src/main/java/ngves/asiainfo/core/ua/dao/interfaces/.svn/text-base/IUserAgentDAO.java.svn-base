package ngves.asiainfo.core.ua.dao.interfaces;
...
public interface IUserAgentDAO {
	...
	public IUserAgentAdapterValue[] queryUserAgentAdapterList(String condition,Map<String, Object> param) throws Exception;
