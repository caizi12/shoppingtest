...
public class WareFirstKindRltBean extends DataContainer implements DataContainerInterface,IWareFirstKindRltValue{

  /**
	 * 
	 */
	private static final long serialVersionUID = 8712498917620299850L;



private static String  m_boName = "ngves.asiainfo.core.common.bo.WareFirstKindRlt";
  ...
  public WareFirstKindRltBean() throws AIException{
      super(S_TYPE);
  }
