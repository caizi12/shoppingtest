...
public class QBOMergeBusiLeastWareCheckBean extends DataContainer implements DataContainerInterface,IQBOMergeBusiLeastWareCheckValue{

	private static final long serialVersionUID = 3345031623202698186L;



private static String  m_boName = "ngves.asiainfo.core.ware.bo.QBOMergeBusiLeastWareCheck";
  ...
  public QBOMergeBusiLeastWareCheckBean() throws AIException{
      super(S_TYPE);
  }
