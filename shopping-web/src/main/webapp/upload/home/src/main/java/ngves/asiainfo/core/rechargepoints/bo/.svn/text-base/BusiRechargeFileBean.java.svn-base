...
public class BusiRechargeFileBean extends DataContainer implements DataContainerInterface, IBusiRechargeFileValue {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3058165368705633404L;

	private static String m_boName = "ngves.asiainfo.core.rechargepoints.bo.BusiRechargeFile";
	...
	public final static String S_BusiRechargeFileId = "BUSI_RECHARGE_FILE_ID";
	...
	public BusiRechargeFileBean() throws AIException {
		super(S_TYPE);
	}
	...
	public void initBusiRechargeFileId(String value) {
		this.initProperty(S_BusiRechargeFileId, value);
	}

	public void setBusiRechargeFileId(String value) {
		this.set(S_BusiRechargeFileId, value);
	}

	public void setBusiRechargeFileIdNull() {
		this.set(S_BusiRechargeFileId, null);
	}

	public String getBusiRechargeFileId() {
		return DataType.getAsString(this.get(S_BusiRechargeFileId));

	}

	public String getBusiRechargeFileIdInitialValue() {
		return DataType.getAsString(this.getOldObj(S_BusiRechargeFileId));
	}
