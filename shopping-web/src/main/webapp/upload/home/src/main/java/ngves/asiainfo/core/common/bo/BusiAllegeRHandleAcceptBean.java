...
public class BusiAllegeRHandleAcceptBean extends DataContainer implements DataContainerInterface,IBusiAllegeRHandleAcceptValue{

  private static String  m_boName = "ngves.asiainfo.core.common.bo.BusiAllegeRHandleAccept";
  ...
  public BusiAllegeRHandleAcceptBean() throws AIException{
      super(S_TYPE);
  }
