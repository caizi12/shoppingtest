...
public class QBODonatedWareInfoBean extends DataContainer implements DataContainerInterface, IQBODonatedWareInfoValue {
	...
	private static String m_boName = "ngves.asiainfo.core.donated.bo.QBODonatedWareInfo";
	...
	public QBODonatedWareInfoBean() throws AIException {
