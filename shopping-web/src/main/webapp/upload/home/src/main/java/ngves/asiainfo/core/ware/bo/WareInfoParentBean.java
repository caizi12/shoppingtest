...
public class WareInfoParentBean extends DataContainer implements DataContainerInterface, IWareInfoParentValue {
	...
	private static String m_boName = "ngves.asiainfo.core.ware.bo.WareInfoParent";
	...
	public WareInfoParentBean() throws AIException {
