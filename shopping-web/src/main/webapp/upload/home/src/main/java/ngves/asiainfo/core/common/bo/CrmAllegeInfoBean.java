...
public class CrmAllegeInfoBean extends DataContainer implements DataContainerInterface,ICrmAllegeInfoValue{

  /**
	 * 
	 */
	private static final long serialVersionUID = -4097233386445389958L;



private static String  m_boName = "ngves.asiainfo.core.common.bo.CrmAllegeInfo";
  ...
  public CrmAllegeInfoBean() throws AIException{
      super(S_TYPE);
  }
