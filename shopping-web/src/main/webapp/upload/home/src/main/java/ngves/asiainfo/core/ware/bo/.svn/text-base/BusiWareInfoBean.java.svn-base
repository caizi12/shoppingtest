...
public class BusiWareInfoBean extends DataContainer implements DataContainerInterface, IBusiWareInfoValue {
	...
	private static String m_boName = "ngves.asiainfo.core.ware.bo.BusiWareInfo";
	...
	public BusiWareInfoBean() throws AIException {
	...
	public void initBusiIdParent(long value) {
		this.initProperty(S_BusiIdParent, new Long(value));
	}

	public void setBusiIdParent(long value) {
		this.set(S_BusiIdParent, new Long(value));
	}

	public void setBusiIdParentNull() {
		this.set(S_BusiIdParent, null);
	}

	public long getBusiIdParent() {
		return DataType.getAsLong(this.get(S_BusiIdParent));

	}

	public long getBusiIdParentInitialValue() {
		return DataType.getAsLong(this.getOldObj(S_BusiIdParent));
	}
