...
public class QBOWareDescInfoBean extends DataContainer implements DataContainerInterface,IQBOWareDescInfoValue{

    private static final long serialVersionUID = -3855051907228367204L;



private static String  m_boName = "ngves.asiainfo.core.rushbuy.bo.QBOWareDescInfo";
  ...
  public QBOWareDescInfoBean() throws AIException{
      super(S_TYPE);
  }
