...
public class QBOTuanWareIntegralBean extends DataContainer implements DataContainerInterface,IQBOTuanWareIntegralValue{

  private static String  m_boName = "ngves.asiainfo.core.tuan.bo.QBOTuanWareIntegral";
  ...
  public QBOTuanWareIntegralBean() throws AIException{
      super(S_TYPE);
  }
