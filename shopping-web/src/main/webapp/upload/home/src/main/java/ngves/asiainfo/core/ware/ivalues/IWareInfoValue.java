...
public interface IWareInfoValue extends DataStructInterface {
	...
	//统一积分改造 ，添加礼品积分值 modify by liuyq@2012/02/20
	...
	// the setter and getter function for the new column ware_integral_value
