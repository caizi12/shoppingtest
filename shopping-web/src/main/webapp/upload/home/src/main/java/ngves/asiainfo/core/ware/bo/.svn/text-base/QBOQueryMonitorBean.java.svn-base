...
public class QBOQueryMonitorBean extends DataContainer implements DataContainerInterface,IQBOQueryMonitorValue{

  private static String  m_boName = "ngves.asiainfo.core.ware.bo.QBOQueryMonitor";
  ...
  public QBOQueryMonitorBean() throws AIException{
