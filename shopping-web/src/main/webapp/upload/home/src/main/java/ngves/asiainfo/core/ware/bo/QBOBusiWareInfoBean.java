...
public class QBOBusiWareInfoBean extends DataContainer implements DataContainerInterface, IQBOBusiWareInfoValue {
	...
	private static String m_boName = "ngves.asiainfo.core.ware.bo.QBOBusiWareInfo";
	...
	public QBOBusiWareInfoBean() throws AIException {
