...
(function(NS) {
    ...
    Lang.augmentObject(NS.Suggest.prototype, {
        ...
        _setContainerRegion: function() {
           ...
           /* var docMode = document.documentMode;
			...
			if(mybrowser.chrome) {
			    ...
			    var msie10 = /msie 10\.0/i.test(browserName);
				var msie9  = /msie 9\.0/i.test(browserName); 
				var msie8 = /msie 8\.0/i.test(browserName);
				var msie7 = /msie 7\.0/i.test(browserName);
				var msie6 = /msie 6\.0/i.test(browserName);
				//alert('msie8 = ' + msie8 + ',msie7 = ' + msie7 + ',msie6=' + msie6 + ',msie9 = ' + msie9)
				if(msie8){
					left -= 3;	
					bottom = bottom - 2;
				}else if(msie7) {
				...
				//alert("hello,welcome to use opera !")
			}
			*/
        ...
        requestData: function() {
            ...
            // 注意：没必要加时间戳，是否缓存由服务器返回的Header头控制,对输入关键字通过encodeURIComponent编码，完成支持中文
            this.queryParams = "q=" + encodeURIComponent(encodeURIComponent(this.query)) + "&code=utf-8&callback=" + CALLBACK_STR;
